...
export function LanguageToggle() {
  ...
  return (
    <button
      ...
      className="relative p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-800 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 w-9 h-9 flex items-center justify-center font-semibold text-lg"
      aria-label="Alternar idioma / Toggle language"
    >
      <motion.span
        initial={false}
        animate={{
          scale: language === "pt" ? 1 : 0,
          opacity: language === "pt" ? 1 : 0,
        }}
      ...
      >
        <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g clipPath="url(#BR_svg__a)">
                ...
                <path d="M9.913 11.74a7.02 7.02 0 0 0-2.086.315 4.173 4.173 0 0 0 7.59 2.34 7.034 7.034 0 0 0-5.504-2.655Zm6.183 1.06a4.174 4.174 0 0 0-7.932-2.447 8.607 8.607 0 0 1 7.932 2.447Z" fill="#0052B4" />
            </g>
            <defs>
      ...
      >
        <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g clipPath="url(#US_svg__a)">
                ...
                <path d="M11.477 12H24a12.01 12.01 0 0 0-.413-3.13H11.478V12Zm0-6.262h10.761a12.064 12.064 0 0 0-2.769-3.13h-7.992v3.13ZM12 24c2.824 0 5.42-.976 7.47-2.609H4.53A11.948 11.948 0 0 0 12 24ZM1.761 18.26h20.477a11.93 11.93 0 0 0 1.348-3.13H.413c.3 1.116.758 2.167 1.348 3.13Z" fill="#D80027" />
