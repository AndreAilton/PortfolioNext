...
export default function Certifications() {
  ...
  return (
    <section
      id="certifications"
      className="scroll-mt-28 mb-28 sm:mb-40 w-full max-w-[53rem]"
    >
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                {item.link && (
                  <div className="text-sm font-medium flex items-center gap-1 text-gray-900 dark:text-gray-100 group-hover:underline group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
